<html>
    ...
    <body>
        ...
        <table width="100%" cellpadding="12" cellspacing="0" border="0">
            <tr bgcolor="black">
                <td align="left"><img src="img/logo.png" alt="TLA logo" height="70" width="70"></td>
                <td>
                    <h1>TLA Consulting</h1>
                </td>
                <td align="right"><img src="img/logo.png" alt="TLA logo" height="70" width="70"></td>
            </tr>
        </table>
        ...
        <table width="100%" bgcolor="white" cellpadding="4" cellspacing="4">
            <tr>
                <td width="25%">
                    <img src="img/s-logo.png" alt="" height="20" width="20">
